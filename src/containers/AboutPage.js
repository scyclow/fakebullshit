  ...
  render() {
    return (
      <div>
        ...
        <p style={{ padding: 20 }}>
          For all errors, typos, website bugs, and content submissions, please open an issue or pull request on <a href="https://github.com/scyclow/fakebullshit">our github page</a>.
        </p>
      </div>
    );
  }
